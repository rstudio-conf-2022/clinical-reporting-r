...
# Final piece to cover before handing over to you is mock tables. In order to
# produce a mock table we just need to swap the printing function for `print_mock_gt`
...
# with data 
added_space %>% 
  print_mock_gt(select(data, -Value))
